      ...
      <section className="features">
        ...
        <div className="features-grid">
          <div className="feature">
            ...
            <h3>Event-based</h3>
            <p>
              Events help you handle any types of real-time interactions with a
              unified mental model, every interaction is an event
            </p>
          </div>
          <div className="feature">
            <div className="feature-icon">
            ...
            <p>
              You can define schemas for events using zod and validate to easily
              avoid mismatch bugs at runtime.
            </p>
          </div>
          <div className="feature">
            <div className="feature-icon">
            ...
            <p>
              Hook into various stages of the event lifecycle for custom logic
              and side effects.
            </p>
          </div>
          <div className="feature">
            ...
            <h3>Unified API</h3>
            <p>
              Server and clients share similar mental models accross
              interactions, so it's easy to reason about things.
            </p>
          </div>
        </div>
      </section>
          ...
          <table className="comparison-table">
            ...
            <tbody>
              ...
              <tr>
                <td>Event System</td>
                <td className="has-feature">
                  Declarative event definitions with first-class support
                </td>
                <td className="no-feature">
                  String-based event names, no structure
                </td>
              </tr>
              <tr>
                <td>Room Management</td>
                <td className="has-feature">
                  Configured upfront with type-safe joins
                </td>
              ...
              <tr>
                ...
                <td className="no-feature">
                  More setup code, repetitive patterns
                </td>
              </tr>
              <tr>
                <td>Runtime Safety</td>
                <td className="has-feature">
                  Events validated against schemas at runtime
                </td>
